...
public class Testcase22 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("The value of attribute is "+value);
			Thread.sleep(2000);
		b.switchtoframeusingidorname("iframe01");
		 b.clickonelementbyidandsenddata("searchInput","google");
		 b.switchtoparentframe();
		 String value2=b.togetattributevale("//button[@id=\"rightClickBtn\"]","oncontextmenu");
			System.out.println("The value of attribute is "+value2);
